...
- Evaluation Metrics (Gross conversion, Net conversion, retention)
  ...
  - **Number of user-ids"** is the count of user who start free-trial. As the hypothesis, Alteritive hypothesis expect change Number of user-ids so it can be an evaluation Metric. However we set Number of clicks invariantly, Gross conversion and Number of user-id have same meaning. So I drop Number of user-ids and decided choose Gross conversion.
